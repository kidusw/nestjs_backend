...
export class FileUploadService {
    ...
    async uploadeFile(file:Express.Multer.File,description:string | undefined,user:User):Promise<File>{
    ...
    async remove(id:string):Promise<void>{
        ...
        if(!fileToBeDeleted){
            throw new NotFoundException('File with the give id not found');
        }
